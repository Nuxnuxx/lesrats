    ...
    public function analyzeProductAttributes(string $title, ?string $visualContext = null, bool $is3DPrint = false): array
    {
        ...
        try {
            ...
            $prompt = "Analyse ce produit et retourne ses attributs en JSON.\n\n"
                ...
                ."- secondary_color : string (deuxième couleur la plus visible si différente de main_color, parmi la liste ci-dessus — mettre null UNIQUEMENT si le produit est vraiment monochrome)\n"
                ...
                ."- secondary_color doit être renseignée dès qu'une deuxième couleur distincte est visible (ex: rouge + noir → secondary_color: Noir)\n"
